 ...
 * @param EdgeType the data type stored at each graph edge as a Number whose
 *                 doubleValue() method returns a value >=0.0
 */
public interface FlightTicketADT<NodeType, EdgeType extends Number> {
	/**
	...
	/**
	 * Returns a list of the shortest paths between startingVertex and
	 * destinationVertex.
	 * 
	 * 
	...
	/**
	 * Returns the cost of the cheapest path (sum over edge weights) between
	 * startingVertex and destinationVertex. Uses Dijkstra's shortest path algorithm
	 ...
	 * @param start the data item in the starting vertex for the path
	 * @param end   the data item in the destination vertex for the path
	 * @return the cost of the least edges path between vertex with data item
	 *         startingVertex and vertex with data item destinationVertex, including
	 *         both startingVertex and destinationVertex
	 */
